...
public class LzItemViewModelBase<TDTO, TModel> : LzViewModelBase,ILzItemViewModelBase, ILzItemViewModelBaseData<TModel>
    where TDTO : class, new()
    where TModel : class, TDTO, new()
{
    public LzItemViewModelBase()
    {
        CanCreate = true;
        CanRead = true;
        CanUpdate = true;
